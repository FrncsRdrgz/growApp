...
public class EditSeedProductionActivity extends AppCompatActivity implements LocationListener {
    ...
    Toolbar toolbar;
    LinearLayout l1,l2,l8,l9,l10, l11,lCoopTv,lCoopEt,lCommitmentTv,lCommitmentEt,lStationTv,lStationEt;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //Log.e(TAG, "designation: "+seedGrowers.getDesignation() );
        if(seedGrowers.getDesignation().matches("PhilRice")){
            philriceForm();
        }else if(seedGrowers.getDesignation().matches("SeedGrower")){
            seedGrowerForm();
        }
    }
    public void updatePhilRiceFunction(){
    ...
    public void philriceForm(){
        ...
        tvSave.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                updatePhilRiceFunction();
            }
        });
    }
    public void seedGrowerForm(){
        //find the view of linear layout
        l10 = (LinearLayout) findViewById(R.id.l10);
        l11 = (LinearLayout) findViewById(R.id.l11);
        lStationEt = (LinearLayout) findViewById(R.id.lStationEt);
