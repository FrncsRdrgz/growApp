...
public class DecVar {
    public static final String receiver() {
        ...
        String localhost = "http://192.168.0.107/growApp";
        return localhost;
    }
    ...
    public static final String userCredentialApiUrl(){
        ...
        String localhost = "http://192.168.0.107/seed_ordering/api/getUserCredentials";
        return localhost;
    }

    public static final String getSeedBought(){
        String production = "https://rsis.philrice.gov.ph/seed_ordering/api/getSeedBought";
        String localhost = "http://192.168.0.107/seed_ordering/api/getSeedBought";
