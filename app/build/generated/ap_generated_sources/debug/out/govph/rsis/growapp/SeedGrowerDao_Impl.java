  ...
  public SeedGrowerDao_Impl(RoomDatabase __db) {
    ...
    this.__insertionAdapterOfSeedGrower = new EntityInsertionAdapter<SeedGrower>(__db) {
      ...
      public void bind(SupportSQLiteStatement stmt, SeedGrower value) {
        ...
        if (value.previousCrop == null) {
          stmt.bindNull(22);
        } else {
          stmt.bindString(22, value.previousCrop);
        }
        if (value.previousVariety == null) {
          stmt.bindNull(23);
        } else {
        ...
        if (value.transplanting_method == null) {
          stmt.bindNull(25);
        } else {
          stmt.bindString(25, value.transplanting_method);
        }
        if (value.region == null) {
          stmt.bindNull(26);
        } else {
          stmt.bindString(26, value.region);
        }
        if (value.province == null) {
          stmt.bindNull(27);
        } else {
          stmt.bindString(27, value.province);
        }
        if (value.municipality == null) {
          stmt.bindNull(28);
        } else {
          stmt.bindString(28, value.municipality);
        }
      }
    };
    ...
    return __db.getInvalidationTracker().createLiveData(new String[]{"seedgrower"}, false, new Callable<List<SeedGrower>>() {
      ...
      public List<SeedGrower> call() throws Exception {
        ...
        try {
          ...
          final int _cursorIndexOfTransplantingMethod = CursorUtil.getColumnIndexOrThrow(_cursor, "transplanting_method");
          ...
          while(_cursor.moveToNext()) {
            ...
            _item.municipality = _cursor.getString(_cursorIndexOfMunicipality);
            _result.add(_item);
          }
          return _result;
        } finally {
  ...
  public SeedGrower findFormById(final String sgId) {
    ...
    try {
      ...
      if(_cursor.moveToFirst()) {
        ...
        _result.province = _cursor.getString(_cursorIndexOfProvince);
        _result.municipality = _cursor.getString(_cursorIndexOfMunicipality);
      } else {
        _result = null;
      }
      return _result;
